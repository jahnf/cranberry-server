...
/* The Content-Disposition header can be used to 'force' a browser to open
...
#define HTTP_CONTENT_TYPE_BZ2            "application/x-bzip2"
#define HTTP_CONTENT_TYPE_TAR            "application/x-tar"
#define HTTP_CONTENT_TYPE_TGZ            "application/x-compressed"
#define HTTP_CONTENT_TYPE_7Z             "application/x-7z-compressed"
...
#define HTTP_CONTENT_TYPE_H_HPP          "text/x-h"
...
#define HTTP_CONTENT_TYPE_WAV            "audio/x-wav"
...
#define HTTP_CONTENT_TYPE_XLSX           "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
#define HTTP_CONTENT_TYPE_PPT            "application/mspowerpoint"
#define HTTP_CONTENT_TYPE_PPTX           "application/vnd.openxmlformats-officedocument.presentationml.presentation"
